...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Region.region_fr'
        db.add_column(u'corewine_region', 'region_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Region.region_en'
        db.add_column(u'corewine_region', 'region_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Appelation.appelation_fr'
        db.add_column(u'corewine_appelation', 'appelation_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Appelation.appelation_en'
        db.add_column(u'corewine_appelation', 'appelation_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Taste.taste_fr'
        db.add_column(u'corewine_taste', 'taste_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Taste.taste_en'
        db.add_column(u'corewine_taste', 'taste_en',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Aroma.aroma_fr'
        db.add_column(u'corewine_aroma', 'aroma_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Aroma.aroma_en'
        db.add_column(u'corewine_aroma', 'aroma_en',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Acidity.acidity_fr'
        db.add_column(u'corewine_acidity', 'acidity_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Acidity.acidity_en'
        db.add_column(u'corewine_acidity', 'acidity_en',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Teint.teint_fr'
        db.add_column(u'corewine_teint', 'teint_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Teint.teint_en'
        db.add_column(u'corewine_teint', 'teint_en',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tanin.tanin_fr'
        db.add_column(u'corewine_tanin', 'tanin_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tanin.tanin_en'
        db.add_column(u'corewine_tanin', 'tanin_en',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Region.region_fr'
        db.delete_column(u'corewine_region', 'region_fr')

        # Deleting field 'Region.region_en'
        db.delete_column(u'corewine_region', 'region_en')

        # Deleting field 'Appelation.appelation_fr'
        db.delete_column(u'corewine_appelation', 'appelation_fr')

        # Deleting field 'Appelation.appelation_en'
        db.delete_column(u'corewine_appelation', 'appelation_en')

        # Deleting field 'Taste.taste_fr'
        db.delete_column(u'corewine_taste', 'taste_fr')

        # Deleting field 'Taste.taste_en'
        db.delete_column(u'corewine_taste', 'taste_en')

        # Deleting field 'Aroma.aroma_fr'
        db.delete_column(u'corewine_aroma', 'aroma_fr')

        # Deleting field 'Aroma.aroma_en'
        db.delete_column(u'corewine_aroma', 'aroma_en')

        # Deleting field 'Acidity.acidity_fr'
        db.delete_column(u'corewine_acidity', 'acidity_fr')

        # Deleting field 'Acidity.acidity_en'
        db.delete_column(u'corewine_acidity', 'acidity_en')

        # Deleting field 'Teint.teint_fr'
        db.delete_column(u'corewine_teint', 'teint_fr')

        # Deleting field 'Teint.teint_en'
        db.delete_column(u'corewine_teint', 'teint_en')

        # Deleting field 'Tanin.tanin_fr'
        db.delete_column(u'corewine_tanin', 'tanin_fr')

        # Deleting field 'Tanin.tanin_en'
        db.delete_column(u'corewine_tanin', 'tanin_en')
