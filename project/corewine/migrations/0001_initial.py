...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'corewine_cepage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 14, 0, 0), auto_now=True, auto_now_add=True, blank=True)),
            ('wineType', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ...
        db.create_table(u'corewine_wine', (
            ...
            ('mouth_intensity', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1)),
            ('nose_intensity', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1)),
            ('persistance', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1)),
