...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'corewine_tag', 'description_fr')

        # Deleting field 'Tag.description_en'
        db.delete_column(u'corewine_tag', 'description_en')
