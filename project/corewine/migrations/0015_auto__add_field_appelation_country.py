...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appelation.country'
        db.add_column(u'corewine_appelation', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['corewine.Country']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appelation.country'
        db.delete_column(u'corewine_appelation', 'country_id')
    ...
    models = {
        u'corewine.acidity': {
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
