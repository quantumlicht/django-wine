...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.country_fr'
        db.add_column(u'corewine_country', 'country_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Country.country_en'
        db.add_column(u'corewine_country', 'country_en',
                      self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.country_fr'
        db.delete_column(u'corewine_country', 'country_fr')

        # Deleting field 'Country.country_en'
        db.delete_column(u'corewine_country', 'country_en')
