...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tag.last_modified'
        db.add_column(u'corewine_tag', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 13, 0, 0), auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Wine.last_modified'
        db.add_column(u'corewine_wine', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 13, 0, 0), auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Cepage.last_modified'
        db.add_column(u'corewine_cepage', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 13, 0, 0), auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Tag.last_modified'
        db.delete_column(u'corewine_tag', 'last_modified')

        # Deleting field 'Wine.last_modified'
        db.delete_column(u'corewine_wine', 'last_modified')

        # Deleting field 'Cepage.last_modified'
        db.delete_column(u'corewine_cepage', 'last_modified')
    ...
    models = {
        ...
        u'corewine.cepage': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 13, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
